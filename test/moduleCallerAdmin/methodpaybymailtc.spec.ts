...
describe('Login like a siteadmin', () => {
    ...
    it('Call Save the Pledge', async () => {
      ...
      const method = await $('//*[@id="donorInformationForm"]/div/div/div/div/div/div/select/option[5]')
      const save_pledge = await $('//*[@id="donorInformationForm"]/div/button[2]')
      const confirm = await $('//*[@id="pledgeConfirmationLightbox"]/div/div/div/button[2]')
      const send = await $('//*[@id="navbar"]/ul[1]/li[2]/a')
      await button.click()
